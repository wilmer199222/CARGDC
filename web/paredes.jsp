        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-tasks"></i> Forms <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="registrar_paredes.html"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Validation</b> </a> </li>
        ...
        <div class="col-md-6">           
          <div class="block-web">          
            <div class="panel-heading">
             ...
             <div class="col-xs-6 col-sm-4"><button type="button" class="btn btn-primary" onclick="window.location.href='registrar_paredes.html'">Nuevo</button></div>
