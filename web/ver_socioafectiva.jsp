...
<link rel="stylesheet" type="text/css" href="plugins/bootstrap-colorpicker/css/colorpicker.css" />
      ...
      List<SocioAfectiva> listSocioAfectivas = new ArrayList();
      listSocioAfectivas = dao.listar();
          ...
          <div class="block-web">          
            <div class="porlets-content">
                ...
                <fieldset disabled><div class="form-group">
                  <label>Código</label>
                  <input type="text" name="idAnimal" placeholder="Código" parsley-trigger="change" class="form-control" value='<%= socioAfectiva.getIdSocioAfectiva()%>'>
                </div><!--/form-group-->
                <div class="form-group">
                  <label>Nombre</label>
                  <input type="text" name="Nombre" placeholder="Nombre" parsley-trigger="change" class="form-control" value='<%= socioAfectiva.getNombre() %>'>
                </div><!--/form-group-->  
                  <div class="form-group">
                  <label>Estado</label>
                  <input type="text" name="Estado"  placeholder="Estado" parsley-trigger="change" class="form-control" value='<%= socioAfectiva.getEstado() %>'>
