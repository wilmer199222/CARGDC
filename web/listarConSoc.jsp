...
<link rel="stylesheet" type="text/css" href="plugins/bootstrap-colorpicker/css/colorpicker.css" />
    ...
    <%
    CondicionSocialDaoImpl dao = new CondicionSocialDaoImpl();
    List<CondicionSocial> listCondicion = new ArrayList();
        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Listar Condicion Social</h3>
            </div>
          <div class="container clear_both padding_fix"> 
      <div class="row">
        ...
        <div class="col-md-6">           
          <div class="block-web">          
            <div class="panel-heading">
              <div class="col-xs-6 col-sm-3"><button type="button" class="btn btn-primary" onclick="window.location.href='registrar_conSoc.jsp'">Nuevo</button></div>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                   <%
                    listCondicion = dao.listar();
                    for(CondicionSocial c : listCondicion){

                        %>
                <tr>
                  <td><%= c.getIdCondiconSocial()%></td>
                  <td><%= c.getNombre() %></td>
                  <td><%= c.getEstado() %></td>
                    <td>
                    <div class="row">
