    ...
    <div class="contentpanel">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1>Techos</h1>
          <h2 class="">Ver Techos</h2>
        </div>
        <div class="pull-right">
          <ol class="breadcrumb">
            <li><a href="#">Techos</a></li>
            <li class="active">Ver Techos</li>
          </ol>
        </div>
      </div>
          ...
          <div class="block-web">          
            <div class="porlets-content">
              ...
              <form action="techosv" method="get">
                  ...
                  <label>Código</label>
                  <input type="text" name="idTecho" parsley-trigger="change" placeholder="Código" class="form-control" value='<%= techo.getIdTecho() %>'>
                </div><!--/form-group-->
