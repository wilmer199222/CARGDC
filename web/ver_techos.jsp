        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Ver Techos</h3>
            </div>
         <div class="container clear_both padding_fix"> 
      <div class="row">
          ...
          <div class="block-web">          
            <div class="porlets-content">
                ...
                <fieldset disabled><div class="form-group">
                  <label>Código</label>
                  <input type="text" name="idPiso" placeholder="Código" parsley-trigger="change" class="form-control" value='<%= techo.getIdTecho()%>'>
                </div><!--/form-group-->
                <div class="form-group">
                  <label>Nombre</label>
                  <input type="text" name="Nombre" placeholder="Nombre" parsley-trigger="change" class="form-control" value='<%= techo.getNombre() %>'>
                </div><!--/form-group-->  
                  <div class="form-group">
                  <label>Estado</label>
                  <input type="text" name="Estado"  placeholder="Estado" parsley-trigger="change" class="form-control" value='<%= techo.getEstado() %>'>
                </div><!--/form-group--></fieldset>
                </div><!--/checkbox-->
                
                </div>
            <div class="col-xs-6 col-sm-3"><button type="button" class="btn btn-primary" onclick="window.location.href='listarTechos.jsp'">Atras</button></div>
              </form>
            </div><!--/porlets-content-->
          <!--/block-web--> 
        </div><!--/col-md-6-->
