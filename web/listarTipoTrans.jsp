...
<link rel="stylesheet" type="text/css" href="plugins/bootstrap-colorpicker/css/colorpicker.css" />
    ...
    List<TipoTransporte> listTrans = new ArrayList();
        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Listar Tipo Transporte</h3>
            </div>
          <div class="container clear_both padding_fix"> 
      <div class="row">
        ...
        <div class="col-md-6">           
          <div class="block-web">          
            <div class="panel-heading">
              <div class="col-xs-6 col-sm-3"><button type="button" class="btn btn-primary" onclick="window.location.href='registrar_tipoTrans.jsp'">Nuevo</button></div>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                   <%
                    listTrans = dao.listar();
                    for(TipoTransporte t : listTrans){

                        %>
                <tr>
                  <td><%= t.getIdTipoTransporte()%></td>
                  <td><%= t.getNombre() %></td>
                  <td><%= t.getEstado() %></td>
                    <td>
                    <div class="row">
