<%@page import="com.caracterizacion.modelo.IntegrantesFamiliar"%>
<%@page import="com.caracterizacion.modelo.CondicionSocial"%>
<%@page import="com.caracterizacion.dao.CondicionSocialDaoImpl"%>
...
<%
     ...
     ArrayList<IntegrantesFamiliar> datosE = sesion.getAttribute("carrito") == null ? null : (ArrayList) sesion.getAttribute("carrito");
%>
...
<script>
	$(document).ready(function() {
		$('#submit').click(function(event) {
			var nomVar = $('#nom').val();
			var apellVar = $('#apell').val();
			var edadVar = $('#edad').val();
                        var parentescVar = $('#parentesc').val();
                        var escolarVar = $('#escolar').val();
                        var ocupaVar = $('#ocupa').val();
                        
			// Si en vez de por post lo queremos hacer por get, cambiamos el $.post por $.get
			$.post('CarritoFamiliaSvl', {
				nombre : nomVar,
				apellido: apellVar,
				edad: edadVar,
                                parentesco: parentescVar,
                                escolaridad: escolarVar,
                                ocupacion: ocupaVar
     ...
     <%
      ...
      List<TipoTransporte> listTipoTransportes = new ArrayList();
       ...
       FormacionDaoImpl daoImpl16 = new FormacionDaoImpl();
       List<NivelFormacion> listNivelFormacion = new ArrayList();
       listNivelFormacion = daoImpl16.listar();
      
       CondicionSocialDaoImpl daoImpl17 =  new CondicionSocialDaoImpl();
       List<CondicionSocial> listCondicionSocials = new ArrayList();
       listCondicionSocials = daoImpl17.listar();
   ...
   <%
                ...
                NivelFormacion nivelFormacion = (NivelFormacion) request.getAttribute("NivelFormacion");
                CondicionSocial condicionSocial = (CondicionSocial) request.getAttribute("CondicionScial");
 ...
 <div class="col-md-12"></div>
      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="block-web">
            <div class="header">
              <h4 class="center">INTEGRANTES DE LA FAMILIA</h4>
            </div>            
            ...
            <form class="form" id="form2">
                        ...
                        <div class="col-sm-5"> 
                            <input type="text" id="nom" name="nombreFamiliar" class="form-control">
                        </div>
                      </div>
                        ...
                        <div class="col-sm-5">
                            <input type="text"  id="apell" name="apellido" class="form-control">
                        </div>
                      </div>
                        
                       <br><br>
                      <div class="form-group">
                        <label class="col-sm-4">Edad</label>
                        <div class="col-sm-5">
                            <input type="number" id="edad" name="edadForm" class="form-control">
                        </div>
                      </div>
                       ...
                       <br><br>
                        ...
                        <div class="col-sm-5"> 
                            <input type="text"  id="parentesc" name="parentesco" class="form-control">
                        </div>
                        </div>                            
                        
                       <br><br>
                    <div class="form-group">
                        <label class="col-sm-4">Escolaridad</label>
                        <div class="col-sm-6">
                            <select name="escolaridad" id="escolar">
                                <option>Seleccione</option>
                                 <%
       
                             for(NivelFormacion nivelFor : listNivelFormacion){
                                 %><option value="<%= nivelFor.getIdNivelFormacion()%>"><%= nivelFor.getNombre()%></option><%
                             }
                         ...
                         <br><br>       
                        <div class="form-group">
                        <label class="col-sm-4">Ocupacion</label>
                        <div class="col-sm-5"> 
                            <input type="text"  id="ocupa" name="ocupacion" class="form-control">
                        </div>
                        </div>         
                       
                       <br><br>
                               <center><input type="button" id="submit" value="Añadir" class="btn btn-primary" /> </center>
                    </form>
          ...
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">AVANCES DE EVALUACION RESULTADO</h3>
            </div>
         <div class="container">
             ...
             <div class="table-responsive"  id="tabla">
                       ...
                       <div class="col-md-12">
                          ...
                          <hr>
                              <div class="header">
                                <h4 class="center">Condiciones Economicas y Social</h4>
                              </div>
                              <br>
             <div class="row">  
                 <div class="col-md-1"></div>
            ...
            <div class="col-md-10">
                  ...
                  <div class="col-sm-5">
                    <input type="text" name="ingresos" class="form-control parsley-validated"  placeholder="ingrese Ingresos">
                  </div>
                  <label class="col-sm-1 control-label">Egresos:</label>
                  <div class="col-sm-4">
                    <input type="text" name="egresos" class="form-control parsley-validated"   placeholder="ingrese Egresos">
                  </div>
                </div><!--/form-group--> 
                
                <div class="form-group">
                  <label class="col-sm-4  control-label">Condicion Social:</label>
                  
                      <select class="col-sm-4" name="condicionSocial">
                          <option>Seleccione</option>
                            <%
       
                             for(CondicionSocial condicionSocial1 : listCondicionSocials){
                                 %><option value="<%= condicionSocial1.getIdCondiconSocial()%>"><%= condicionSocial1.getNombre()%></option><%
                             }
