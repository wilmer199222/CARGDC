        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Modificar Paredes</h3>
            </div>
          ...
          <div class="block-web">          
            <div class="porlets-content">
                ...
                <div class="form-group">
                  <label>Código</label>
                  <input type="text" name="idParedes" parsley-trigger="change" placeholder="Código" class="form-control" value='<%= pared.getIdParedes()%>'>
                </div><!--/form-group-->
                <div class="form-group">
                  <label>Nombre</label>
                  <input type="text" name="nombre" parsley-trigger="change"  placeholder="Nombre" class="form-control" value='<%= pared.getNombre() %>'>
                </div><!--/form-group-->  
                  <div class="form-group">
                  <label>Estado</label>
                  <input type="text" name="estado" parsley-trigger="change" placeholder="Estado" class="form-control" value='<%= pared.getEstado() %>'>
                </div><!--/form-group-->
                </div><!--/checkbox-->
