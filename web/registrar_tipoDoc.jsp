        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Registrar Tipo documento</h3>
            </div>
          <div class="container clear_both padding_fix"> 
      <div class="row">
        ...
        <div class="col-md-6">           
          <div class="block-web">          
            <div class="porlets-content">
                <form action="documentosvl" method="get">
                <div class="form-group">
                  <label>Código</label>
                  <input type="number" name="idTipoDocumento" id="idTipoDocumento" parsley-trigger="change" placeholder="Código" class="form-control" >
                </div><!--/form-group-->
                <div class="form-group">
                  <label>Nombre</label>
                ...
                <button type="button" class="btn btn-primary" onclick="window.location.href='listarTipoDoc.jsp'">Cancelar</button>
                </div>
              </form>
            </div><!--/porlets-content-->
          <!--/block-web--> 
