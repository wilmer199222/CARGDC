        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Registrar Regimen Salud</h3>
            </div>
          <div class="container clear_both padding_fix"> 
      <div class="row">
          ...
          <div class="block-web">          
            <div class="porlets-content">
                ...
                <div class="form-group">
                  <label>Código</label>
                  <input type="number" name="idregimenSalud" id="idregimenSalud" parsley-trigger="change" placeholder="Código" class="form-control" >
                </div><!--/form-group-->
                <div class="form-group">
                  <label>Nombre</label>
                ...
                <button type="button" class="btn btn-primary" onclick="window.location.href='listarRegSal.jsp'">Cancelar</button>
                </div>
              </form>
            </div><!--/porlets-content-->
          <!--/block-web--> 
