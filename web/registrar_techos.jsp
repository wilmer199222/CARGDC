          ...
          <div class="block-web">          
            <div class="porlets-content">
                ...
                <div class="form-group">
                  <label>Código</label>
                  <input type="text" name="idTecho" id="idTecho" parsley-trigger="change" placeholder="Código" class="form-control">
                </div><!--/form-group-->
                <div class="form-group">
                  <label>Nombre</label>
                ...
                <button type="submit" class="btn btn-primary" onclick="window.location.href='listarTechos.jsp'">Cancelar</button>
