...
<link rel="stylesheet" type="text/css" href="plugins/bootstrap-colorpicker/css/colorpicker.css" />
    ...
    List<RegimenSalud> listRegimen = new ArrayList();
        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Listar Regimen Salud</h3>
            </div>
          <div class="container clear_both padding_fix"> 
      <div class="row">
        ...
        <div class="col-md-6">           
          <div class="block-web">          
            <div class="panel-heading">
              <div class="col-xs-6 col-sm-3"><button type="button" class="btn btn-primary" onclick="window.location.href='registrar_regSal.jsp'">Nuevo</button></div>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                   <%
                    listRegimen = dao.listar();
                    for(RegimenSalud r : listRegimen){

                        %>
                <tr>
                  <td><%= r.getIdregimenSalud()%></td>
                  <td><%= r.getNombre() %></td>
                  <td><%= r.getEstado() %></td>
                    <td>
                    <div class="row">
