        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Registrar Acompañantes</h3>
            </div>
          <div class="container clear_both padding_fix"> 
      <div class="row">
          ...
          <div class="block-web">          
            <div class="porlets-content">
                ...
                <div class="form-group">
                  <label>Código</label>
                  <input type="number" name="idAcompañante" id="idAcompañante" parsley-trigger="change" placeholder="Código" class="form-control" >
                </div><!--/form-group-->
                <div class="form-group">
                  <label>Nombre</label>
