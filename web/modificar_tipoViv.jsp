        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Modificar Tipo Vivienda</h3>
            </div>
        ...
        <div class="col-md-6">           
          <div class="block-web">          
            <div class="porlets-content">
                <%
                TipoViv tipo = (TipoViv) request.getAttribute("tipovivenda");
                %>  
                
                <form action="tipovivsv" method="get">
                <div class="form-group">
                  <label>Código</label>
                  <input type="text" name="idTipo" parsley-trigger="change" placeholder="Código" class="form-control" value='<%= tipo.getIdTipo()%>'>
                </div><!--/form-group-->
                <div class="form-group">
                  <label>Nombre</label>
                  <input type="text" name="nombre" parsley-trigger="change"  placeholder="Nombre" class="form-control" value='<%= tipo.getNombre() %>'>
                </div><!--/form-group-->  
                  <div class="form-group">
                  <label>Estado</label>
                  <input type="text" name="estado" parsley-trigger="change" placeholder="Estado" class="form-control" value='<%= tipo.getEstado() %>'>
                </div><!--/form-group-->
                </div><!--/checkbox-->
