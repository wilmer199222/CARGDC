        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Listar Paredes</h3>
            </div>
          <div class="container clear_both padding_fix"> 
      <div class="row">
        ...
        <div class="col-md-6">           
          <div class="block-web">          
            <div class="panel-heading">
              <div class="col-xs-6 col-sm-3"><button type="button" class="btn btn-primary" onclick="window.location.href='registrar_paredes.jsp'">Nuevo</button></div>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                   <%
                    ...
                    for(Paredes p : listParedes){

                        %>
                <tr>
                  <td><%= p.getIdParedes()%></td>
                  <td><%= p.getNombre() %></td>
                  <td><%= p.getEstado() %></td>
                    <td>
                    <div class="row">
                        <div class="col-1 col-md-1">
                             ...
                             <input type="hidden" name="idParedes" value='<%= p.getIdParedes()%>'/>
                            </form> 
                        </div>
                        <div class="col-1 col-md-1">
