        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Modificar Acompañantes</h3>
            </div>
        ...
        <div class="col-md-6">           
          <div class="block-web">          
            <div class="porlets-content">
                ...
                <form action="acompañantesv" method="get">
                <div class="form-group">
                  <label>Código</label>
                  <input type="text" name="idAcompañante" parsley-trigger="change" placeholder="Código" class="form-control" value='<%= acompañante.getIdAcompañante()%>'>
                </div><!--/form-group-->
                <div class="form-group">
                  <label>Nombre</label>
                  <input type="text" name="nombre" parsley-trigger="change"  placeholder="Nombre" class="form-control" value='<%= acompañante.getNombre() %>'>
                </div><!--/form-group-->  
                  <div class="form-group">
                  <label>Estado</label>
                  <input type="text" name="estado" parsley-trigger="change" placeholder="Estado" class="form-control" value='<%= acompañante.getEstado() %>'>
                </div><!--/form-group-->
                </div><!--/checkbox-->
                ...
                <button type="button" class="btn btn-primary" onclick="window.location.href='listarAcompañante.jsp'">Cancelar</button>
