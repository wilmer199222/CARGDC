    ...
    <div class="contentpanel">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1>Tipo Vivienda</h1>
          <h2 class="">Ver Tipo Vivienda</h2>
        </div>
        <div class="pull-right">
          <ol class="breadcrumb">
            <li><a href="#">Tipo Vivienda</a></li>
            <li class="active">Ver Tipo Vivienda</li>
          </ol>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6">           
          <div class="block-web">          
            ...
            <div class="col-xs-6 col-sm-3"><button type="button" class="btn btn-primary" onclick="window.location.href='listarTipoViv.jsp'">Atras</button></div>
              </form>
            </div><!--/porlets-content-->
          <!--/block-web--> 
        </div><!--/col-md-6-->
