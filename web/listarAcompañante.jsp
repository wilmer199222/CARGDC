        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Listar Acompañantes</h3>
            </div>
          <div class="container clear_both padding_fix"> 
      <div class="row">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                   <%
                    ...
                    for(Acompañante a : listAcompañante){

                        %>
                <tr>
                  <td><%= a.getIdAcompañante()%></td>
                  <td><%= a.getNombre() %></td>
                  <td><%= a.getEstado() %></td>
                    <td>
                    <div class="row">
                        <div class="col-1 col-md-1">
                             ...
                             <input type="hidden" name="idAcompañante" value='<%= a.getIdAcompañante()%>'/>
                            </form> 
                        </div>
                        <div class="col-1 col-md-1">
