 ...
 * @author ESTUDIANTES
 */
public class DetallaPisosDaoImpl implements IDAO{
...
DetallaPisos objDeta = (DetallaPisos) obj;
         try {
            psmt = con.conectar().prepareStatement("INSERT INTO detalla_pisos VALUES (null,?,?)");
//            psmt.setInt(1, objDeta.getIdDetallaPisos());
            psmt.setInt(1, objDeta.getIdCar());
            psmt.setInt(2, objDeta.getIdPiso()); 
...
//       DetallaPisos objDeta = new DetallaPisos(1,1,1);
//       DetallaPisosDaoImpl dao = new DetallaPisosDaoImpl();
