...
public class PisosDaoImpl implements IDAO {
    ...
    public String modificar(Object obj) throws SQLException {
        ...
        try {
            psmt = con.conectar().prepareStatement("UPDATE pisos SET nombre=? estado=? WHERE idPiso=?");
                               
            psmt.setString(1, objPiso.getNombre());                        
            psmt.setString(2, objPiso.getEstado());          
            psmt.setInt(3, objPiso.getIdPiso()); 
          
            psmt.executeUpdate();
            respuesta = "La Actualización se realizo con exito";
