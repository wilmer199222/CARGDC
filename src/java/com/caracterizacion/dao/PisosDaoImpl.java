...
public class PisosDaoImpl implements IDAO {
    ...
    public PisosDaoImpl() {
        ...
        con.setUrl("jdbc:mysql://localhost:3306/gdc_car");
        con.setUsuario("root");
    ...
    public String modificar(Object obj) throws SQLException {
        Pisos objPiso = (Pisos) obj;
        try {
            psmt = con.conectar().prepareStatement("UPDATE pisos SET nombre=? AND estado=? WHERE idProducto=?");
    ...
    public Object buscarPorID(String id) throws SQLException {
         try {
            psmt = con.conectar().prepareStatement("SELECT * FROM pisos WHERE idProducto=?");
            psmt.setString(1,id);
            rs = psmt.executeQuery();
            while (rs.next()) {                
